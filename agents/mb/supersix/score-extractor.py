...
if __name__ == "__main__":
    ...
    parser.add_argument("-dm", "--dump_matches", type=bool, help="Dump match score extracts")
    parser.add_argument("-ds", "--dump_scores", type=bool, help="Dump player score extracts")
